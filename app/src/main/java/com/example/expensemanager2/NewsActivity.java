...
public class NewsActivity extends AppCompatActivity {
    ...
    private void fetchFinanceNews() {
        String url = "https://api.myjson.online/v1/records/2580419c-146b-4122-936a-54abae4f0b64"; // Replace with your JSON URL
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            JSONArray dataArray = mainData.getJSONArray("data");
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e("NewsActivity", "Error: " + error.getMessage());
            }
        });
